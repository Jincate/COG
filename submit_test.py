...
env = CogEnvDecoder(env_name="../win_v2.1/cog_sim2real_env.exe", no_graphics=False, time_scale=1, worker_id=1) #   "win_v1/RealGame.exe"

num_eval_episodes = 10

eval_agent = Agent(model_path="./model_path/")
